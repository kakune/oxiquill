...
`test:rust:coverage` uses `cargo-llvm-cov` and requires 100% line/function/region coverage for helper crates. If no helper crates exist, helper commands skip cleanly.
